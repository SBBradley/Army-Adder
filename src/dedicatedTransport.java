...
public class dedicatedTransport extends unitBuilder {
   ...
   * 
   * @param dedicatedTransportUnitPointValIn inputs
   *                                         dedicatedTransportUnitPointVal.
   */
   ...
   * 
   * @param dedicatedTransportTotalPointValIn inputs
  ...
  public void dedicatedTransportPointCalculator() {
    try {
      ...
      dedicatedTransportUnitPointVal = (dedicatedTransportChoice.getNumInUnit()
          * dedicatedTransportChoice.getPointVal()) + dedicatedTransportChoice.getUpgradePoints();

      // Holds a running total of how many pts the dedicatedTransport units cost in
      // total.
