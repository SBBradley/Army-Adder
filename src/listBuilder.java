...
public class listBuilder {
   ...
   // Method that exports to a text document with a summary of all created units
   // and stats.
   public static void createList() {
      ...
      // Adds a filewriter and writes all entered info from the user to a txt file to
      // used.
      try {
   ...
   public static void unitCreate() {
      try {
         ...
         // While loop for getting multiple unit creations, will terminate if user inputs
         // "no".
         while (reply.equalsIgnoreCase("yes")) {
            ...
            // This if-else-if statement will call each appropriate method for selected
            // battleRole.
