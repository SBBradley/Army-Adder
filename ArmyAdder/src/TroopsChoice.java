...
* Date: Jan. 16, 2022
*/
public class TroopsChoice extends UnitBuilder {

//Constructor that takes the parameters of the unit.
   public TroopsChoice(String UnitName, String BattleRole, int NumInUnit, int PointVal) {
...
//toString method returns the unit info in string form.
   public String toString() {
      ...
      output = "Troops choice: " + UnitName.toUpperCase() + "\n" +
