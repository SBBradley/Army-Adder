...
//Constructor that takes the parameters of the unit.
   public HQ(String unitName, String battleRole, String specialWeapons, String upgrades,
    String remarks, int numInUnit, int pointVal) {
...
//toString method returns the unit info in string form.
   public String toString() {
      ...
      output = "HQ: " + unitName.toUpperCase() + "\n" 
